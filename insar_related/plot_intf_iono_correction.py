...
if __name__ == '__main__':
    ...
    # crop
    os.system("gdal_translate -of VRT -b 2 -projwin 0 2100 2814  4189 %s %s"%(intfGeo+'.vrt',intfCropped))
    os.system("gdal_translate -of VRT -b 2 -projwin 0 2100 2814  4189 %s %s"%(intfMinIonGeo+'.vrt',intMinIonCropped))
    ...
    plt.gca().invert_xaxis()
    ax1.title.set_text('Corrected Interferogram')
    ax1.xaxis.set_visible(False)
    ax1.yaxis.set_visible(False)
    ax1.set_aspect(aspect)   
