...
def cmdLineParse():
    ...
    parser.add_argument('-g', '--geocode_box', dest='geoBox', type=float, nargs = '+', default=None,
            help='Coordinates for geocode bounding box')
...
def writeXmlFile(inps,frame,master,slave):
    ...
    f.write('''      <property name="geocode bounding box">[3.90, 5.70, 95.20, 97.07]</property> ''' + '\n')
